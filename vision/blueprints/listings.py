...
def create():
    ...
    if request.method == 'POST':
        ...
        featured_price = None
        if is_featured:
            featured_price = SiteSetting.get('featured_listing_price', '5000')
            featured_duration = int(SiteSetting.get('featured_listing_duration_days', '7'))
...
def make_featured(id):
    ...
    price = SiteSetting.get('featured_listing_price', '5000')
    duration = int(SiteSetting.get('featured_listing_duration_days', '7'))
